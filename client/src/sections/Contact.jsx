...
const CONTACT_POINTS = [
  {
    ...
    value: (
      <a
        href="https://maps.google.com/?q=102+Kraft+Ave+Bronxville+NY+10708"
        target="_blank"
      ...
      >
        <span className="block">102 Kraft Ave</span>
  ...
  },
  {
    ...
    body: 'Call for same-day reservations, large party inquiries, or general questions. Email us at hello@cafenelo.com.',
    href: 'tel:+19147797777',
    hrefLabel: 'Call Café Nelo',
    linkText: 'Call now',
  },
];
    ...
    <section id="visit" className="bg-ts-cream py-20">
      <FadeIn className="mx-auto flex max-w-7xl flex-col gap-12 px-6" delayStep={0.14}>
        <SectionTitle
          ...
          description="Café Nelo is located in the heart of the Bronxville village. Come hungry, stay late."
        />
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Get directions to Café Nelo — opens in your maps app"
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-ts-muted">102 Kraft Ave, Bronxville, NY 10708</p>
            </div>
          </div>
